...
In this project we will orchestrate the movement of NYC taxi Trips raw data, starting from landing data into lakehouse to creating semantic models and visualizations using cleaned, transformaed data from data warehouse.
